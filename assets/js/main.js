document.addEventListener('DOMContentLoaded', function () {
  ...
  async function loadTrustPartners() {
    try {
      ...
      // Regrouper les partenaires par priorité
      ...
      // Obtenir les priorités triées (du plus petit au plus grand)
      const sortedPriorities = Object.keys(priorityGroups).map(Number).sort((a, b) => a - b);

      // Créer un nouveau tableau avec les groupes triés par priorité et mélangés en interne
      const finalPartners = [];
